...
# Original theme
# if [ ! -e /var/www/html/wp-content/themes/wch2019 ]; then
#	git clone https://github.com/wchaneda2019/wch2019.git /var/www/html/wp-content/themes/wch2019
#fi
#wp theme activate wch2019
